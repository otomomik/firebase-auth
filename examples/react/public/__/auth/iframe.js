...
;(function () {
  ...
  ea('WeakMap', function (a) {
    ...
    h.prototype.delete = function (l) {
      return c(l) && sa(l, f) && sa(l[f], this.Pa) ? delete l[f][this.Pa] : !1
    }
    return h
  })
  ea('Map', function (a) {
...
*/
  ...
  var sb = function (a) {
      ...
      Ia("expected object of type SafeUrl, got '" + a + "' of type " + va(a))
  ...
  var Eb = {},
    Fb = function () {
      if (Eb !== Eb) throw Error('SafeStyle is not meant to be built directly')
      this.Pl = ''
    }
  ...
  function Ob() {
    return Mb()
      ? Lb('Chromium')
      : ((A('Chrome') || A('CriOS')) && !(Mb() ? 0 : A('Edge'))) || A('Silk')
  }
  var Pb = {},
    Qb = function (a, b) {
...
*/
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var ee,
    ...
    Le = function (a) {
      if (-1 !== fe) return Je(), ge ? p.JSON.stringify.call(p.JSON, a) : pe(a)
    },
    Me =
  ...
  var ef = {
    ...
    kf = function (a, b, c, d) {
      ...
      !g &&
        c &&
        ((g =
          Kd(a.location.href, '_gfid', '') || Kd(a.location.href, 'id', '')),
          ...
          switch (c) {
            ...
            case Array.prototype:
              ...
              var d =
                ...
                ']'
              b.delete(a)
              c !== Array.prototype && (d = Ff(c.constructor) + '(' + d + ')')
              return d
        ...
        if (B.Qg) {
          if (!(m = Lh[f].dm)) {
            ...
            for (f = C.parent; f !== C.top; ) {
              var S = f.parent
              if (!y--) {
                for (var Ba = null, Dc = S.frames.length, re = 0; re < Dc; ++re)
                  S.frames[re] == f && (Ba = re)
                m.unshift('{' + Ba + '}')
              }
              f = S
  ...
  k.applyIframesApi = function (a) {
    ...
    if (!(0 <= dd.call(this.dg, a))) {
      this.dg.push(a)
      a = Fg[a] || { map: {} }
      for (var b in a.map) ed(a.map, b) && this.register(b, a.map[b], a.filter)
    }
  }
  k.getWindow = function () {
  ...
  var mi = function (a) {
    var b = {}
    if (a)
      for (var c in a) ed(a, c) && ed(Rf, c) && Sf.test(a[c]) && (b[c] = a[c])
    return b
  }
  k = I.prototype
  ...
  k.Jl = function (a) {
    ...
    return this.getContext()
      ...
      .then(function (e) {
        ...
        g = new H()
        rh(oh(qh(ph(g, e.ob()), e.zj), e.getFrameName()), e.getOrigin()).ze(f)
        return g.value()
      })
  }
  k.Zl = function (a) {
  ...
  var J = function (a) {
    ...
    this.oj = (this.eh = Ai(this.hb, 'parent')) ? Ai(this.hb, 'pfname') : ''
  ...
  J.prototype.open = function (a, b) {
    ...
    if (Di(this, c, d) || Ei(this, c, d) || Di(this, c, d)) return d.promise
    if (null != lh(c)) {
  ...
  r('gapi.iframes.Context.prototype.getGlobalParam', J.prototype.getGlobalParam)
  r('gapi.iframes.Context.prototype.setGlobalParam', J.prototype.setGlobalParam)
  ...
  r('gapi.iframes.Context.prototype.connectIframes', J.prototype.connectIframes)
  ...
  var hj = function (a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var f = a[e]
      if (!f.xe && f.listener == b && f.capture == !!c && f.af == d) return e
    }
    return -1
  }
...
*/
      ...
      for (var d = (c = !1); a.Of.length && !a.kg; ) {
        ...
        if ((f = a.de ? g : f))
          try {
            ...
            h === Yj && (h = void 0)
            void 0 !== h &&
              ((a.de = a.de && (h == b || h instanceof Error)), (a.Ua = b = h))
            if (
              kg(b) ||
  ...
  K.prototype.send = function (a, b, c, d) {
    ...
    if ('setAttributionReporting' in this.u && this.ig)
      try {
        ...
        Id(this.Da, nk(this, 'Error SetAttributionReporting: ' + g.message))
      }
    try {
      ok(this),
        0 < this.Jd &&
  ...
  K.prototype.lj = function () {
    this.isDisposed() || (this.Mg || this.lf || this.Mc ? sk(this) : this.Hl())
  }
  ...
  K.prototype.getAllResponseHeaders = function () {
    return this.u && 2 <= tk(this) ? this.u.getAllResponseHeaders() || '' : ''
  }
  var nk = function (a, b) {
  ...
  var angular,
    ...
    rl = { DEFAULT: 'FirebaseCore-web', Hm: 'FirebaseUI-web', Km: 'gcip-iap' },
    sl = function (a, b, c) {
      c = c || []
      var d = [],
        e = {},
      ...
      d = ol()
      return (
        ('Browser' === d ? $k(Vk()) : 'Worker' === d ? $k(Vk()) + '-' + d : d) +
        '/' +
        a +
        '/' +
        b +
    ...
    ul = function () {
      try {
        var a = p.localStorage,
          b = tl()
        if (a)
          return a.setItem(b, '1'), a.removeItem(b), Wk() ? !!p.indexedDB : !0
      } catch (c) {
    ...
    wl = function () {
      return (
        (vl() || 'chrome-extension:' === ll() || jl()) && !pl() && ul() && !nl()
      )
    },
    vl = function () {
    ...
    Bl = function (a) {
      a = a || Vk()
      return 'Safari' == $k(a) || a.toLowerCase().match(/iphone|ipad|ipod/)
        ? !1
        : !0
    },
    Cl = function () {
  ...
  var mn = function (a, b, c) {
      ...
      c &&
        ((this.ld['X-Client-Version'] = c), (this.Mf['X-Client-Version'] = c))
      a = 'Node' == ol()
      a =
        p.XMLHttpRequest ||
  ...
  var wn = function (a, b) {
    ...
    yn = function (a) {
      a = a.email
      if ('string' !== typeof a || !hl.test(a)) throw new P('invalid-email')
    },
    zn = function (a) {
      'email' in a && yn(a)
    },
  ...
  var Ym = function (a, b) {
    ...
    Xn = function (a) {
      var b = null
      a.needConfirmation
        ? ((a.code = 'account-exists-with-different-credential'), (b = en(a)))
  ...
  var Q = function (a, b, c) {
    ...
    Wn = function (a) {
      return vn({ error: { errors: [{ message: a }], code: 400, reason: a } })
    },
    vn = function (a, b) {
      var c =
  ...
  vo.prototype.toString = function () {
    ...
    this.oh ? L(a, 'redirectUrl', this.oh) : a.removeParameter('redirectUrl')
  ...
  var Po = function (a, b, c, d, e, f, g) {
    ...
    this.ai = b
    this.be = null
    g ? (Oo || (Oo = new No()), (g = Oo)) : (Go || (Go = new Eo()), (g = Go))
    this.xj = g
  ...
  Bp.prototype.Pg = function (a) {
    ...
    if ((b = a.iOS) && 'object' === typeof b)
      if (((b = b.bundleId), 'string' === typeof b && b.length)) this.Hi = b
      else {
        if ('undefined' !== typeof b)
          throw new P(
            'argument-error',
            ...
            if (h && g && g.url) {
              ...
              ;-1 != l.indexOf('/__/auth/callback') &&
                ...
                (m = (m = 'object' === typeof m ? Yl(m) : null)
                  ...
                  : new Zl(h.getType(), h.Ja, l, h.ae(), null, null, h.ma)))
              l = m || b
            }
            a.Ud(l)
          })
  ...
  yq.prototype.re = function (a, b, c, d) {
    ...
    return rq(this.ne).then(function () {
      return e.qb
        .re(a, b, c, d)
        .l(function (g) {
          if (zq(g)) throw new P('operation-not-supported-in-this-environment')
          f = g
  ...
  var ar = function (a, b) {
    this.ci = a || null
    this.Si = b || null
    Pl(this, { lastSignInTime: Hl(b || null), creationTime: Hl(a || null) })
  }
  ...
  var br = function (a, b, c, d, e, f) {
    ...
    R = function (a, b, c) {
      ...
      var d = firebase.SDK_VERSION ? sl('JsCore', firebase.SDK_VERSION) : null
  ...
  var fr = function (a, b) {
    ...
    gr = function (a, b) {
      ...
      rn(
        a.o,
        firebase.SDK_VERSION ? sl('JsCore', firebase.SDK_VERSION, a.Ea) : null
      )
    },
    jr = function (a, b) {
  ...
  var kr = function (a) {
    ...
    lr = function (a) {
      a.jd ||
        a.Ad.xd ||
        (a.Ad.start(), vj(a, 'tokenChanged', a.Nd), nj(a, 'tokenChanged', a.Nd))
    },
    mr = function (a) {
  ...
  k.ni = function (a, b, c, d) {
    ...
    c = this.getIdToken()
      .then(function (g) {
        return tm(e.o, { requestUri: a, postBody: d, sessionId: b, idToken: g })
      })
      .then(function (g) {
        f = yr(e, g, 'link')
        return Ar(e, g)
  ...
  k.oi = function (a, b, c, d) {
    ...
    var f = null,
      g = F()
        .then(function () {
          return qm(
            um(e.o, { requestUri: a, sessionId: b, postBody: d, tenantId: c }),
            e.uid
          )
        })
        .then(function (h) {
  ...
  k.sendEmailVerification = function (a) {
    ...
    return this.v(
      this.getIdToken()
        .then(function (d) {
          c = d
          return 'undefined' === typeof a || Ya(a) ? {} : Cp(new Bp(a))
        })
        .then(function (d) {
  ...
  k.verifyBeforeUpdateEmail = function (a, b) {
    ...
    return this.v(
      this.getIdToken()
        .then(function (e) {
          d = e
          return 'undefined' === typeof b || Ya(b) ? {} : Cp(new Bp(b))
        })
        .then(function (e) {
    ...
    return a.Ob && !c
      ...
      : b.l(function (d) {
          !d ||
            ...
            (a.Ob || a.dispatchEvent(new Sq('userInvalidated')), (a.Ob = d))
          throw d
        })
  }
  ...
  T.prototype.Gd = function (a) {
    this.Gb === a ||
      this.wb ||
      ((this.Gb = a), on(this.o, this.Gb), this.dispatchEvent(new $r(this.Gb)))
  }
  ...
  T.prototype.yl = function (a) {
    ...
    rn(
      this.o,
      firebase.SDK_VERSION ? sl('JsCore', firebase.SDK_VERSION, this.Ea) : null
    )
    ...
    c = ds(this)
      ...
      .then(function () {
        return new E(function (g, h) {
          b.Tc('signInViaPopup', null, new P('cancelled-popup-request'), b.Kb)
          b.Jb = g
          b.Rc = h
          b.Kb = d
  ...
  var gs = function (a, b) {
    ...
    Vr = function (a, b) {
      ...
      b &&
        ...
        0 < a.Ic && lr(b))
      O(a, 'currentUser', b)
      b && (b.Gd(a.Gb), hr(b, a), gr(b, a.Ea), jr(b, a), fr(b, a.N), ir(b, a))
    }
  ...
  k.sm = function () {
    ...
    return Ur(this.Pb, b).then(function (c) {
      if (!a.wb) {
        ...
        if (U(a) || c)
          Vr(a, c), c && (pr(c), (c.xc = a.Sc)), a.W && a.W.subscribe(a), a.rc()
      }
    })
  }
  k.oc = function (a) {
  ...
  k.delete = function () {
    ...
    for (var a = 0; a < this.Ka.length; a++) this.Ka[a].cancel('app-deleted')
    this.Ka = []
    this.Pb && ((a = this.Pb), a.O.removeListener(Mr('local'), a.V, this.Hg))
  ...
  Y(Dp.prototype, { confirm: { name: 'confirm', j: [V('verificationCode')] } })
  Z(
    pm,
    'fromJSON',
    function (a) {
  ...
  var Es = function (a, b) {
    return a.Bf.sendMessage({ type: 'authEvent', authEvent: b && b.T() }).then(
      function (c) {
